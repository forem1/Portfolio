# Generated by Django 3.2.10 on 2021-12-14 21:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_tag', models.ManyToManyField(to='Site.Tag', verbose_name='Теги')),
            ],
            options={
                'verbose_name': 'Статья',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.CharField(max_length=50, verbose_name='Автор')),
                ('pub_date', models.DateTimeField(auto_now=True, verbose_name='Дата публикации')),
                ('fk_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Site.post')),
            ],
            options={
